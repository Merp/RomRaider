...
//                tableNode, "type", String.valueOf(table.getTableType()))));
...
//                table.getCategory()));
//        if (table.getStorageBytes() < 1) {
//            table.setSignedData(RomAttributeParser
//                    .parseStorageDataSign(unmarshallAttribute(tableNode,
//                            "storagetype",
//                            String.valueOf(table.getStorageBytes()))));
//        }
//        table.setStorageBytes(RomAttributeParser
...
//                table.getLogParam()));
//
//        if (table.getTableType() == Settings.TABLE_3D) {
...
//
//                    if (table.getTableType() == Settings.TABLE_2D) { // if table is 2D,
//                        // parse axis
//
...
//
//                        }
//                    } else if (table.getTableType() == Settings.TABLE_3D) { // if table
//                        // is 3D,
//                        // populate
//                        // xAxis
//                        if (RomAttributeParser
